...
- Developed a full-stack, scheduling app for a garden center’s delivery service.
  Provides an intuitive stepped-form for accurate data entry, calculates and
  lists available delivery times and includes a drag-n-drop feature to maintain
  schedule integrity.
- Built with TypeScript, React, Next.js, Chakra-UI, React-DnD, React Query,
  React Hook Form, and MongoDB.
